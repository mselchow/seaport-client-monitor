        ...
        <Card>
            ...
            <CardContent>
                {isSignedIn ? (
                    <>
                        <p>
                            To get started, you need to add your Clockify API
                            key below:
                        </p>
                        <ol className="list-decimal space-y-2 pl-8 pt-2">
                            ...
                            <li>
                                At the bottom of the page, find the API key
                                section
                            </li>
                            <li>
                                If no key exists, click the generate button to
                                create a new one
                            </li>
                            <li>
                        ...
                        <p className="pt-6">
                            Once you save your API key, you will have full
                            access to all pages on the site.
                        </p>
                    </>
                ) : (
